...
Este pequeno projeto tem como objetivo realizar a predição de valores para avaliação de eficiência energética para construções diversa através de uma API desenvolvida seguindo o estilo REST.
